  ...
  return (
    <div className="flex justify-between bg-gradient-to-r from from-[#FDF3FA] to-[#F7F7F7] overflow-hidden relative">
      ...
      <div className="w-[45%] pl-[65px] flex flex-col justify-center gap-1 lg:gap-3 relative">
        ...
        <button className="w-[50%] px-1 py-1 lg:px-4 lg:py-2 bg-[#BF4C9A] text-white font-sans text-xs sm:text-xs md:text-sm rounded-lg relative">
          <img src={star2} alt="start2" className="absolute w-[47px] h-[51px] right-[-100px] bottom-[-100px]" />
