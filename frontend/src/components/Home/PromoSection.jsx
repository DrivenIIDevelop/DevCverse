...
export default function PromoSection() {
  ...
  return (
    <div className="flex mt-14 mx-14">
      ...
      <div className="w-[50%] flex flex-col items-center justify-center bg-[#E7FFE4] text-[#3F8947] py-24 px-8 gap-y-2">
        <p className="font-sans text-xl ">
          UP TO 30% OFF ALL HERBIVORE PRODUCTS
        </p>

        <p className="font-serif text-[40px] w-[80%] flex justify-center">
          Plant Powered for ALL
        </p>
        <p className="font-serif text-[40px] w-[80%] flex justify-center">
          Skin Types
        </p>
        ...
        <button
          className="px-8 py-4 w-[40%] bg-[#3F8947] rounded-lg text-sm text-[#262626] mt-4"
          onClick={handleClick}
        >
          Shop for the Herbivore
        </button>
      </div>
    </div>
  );
